...
# #         self.conv = nn.Sequential(
# #             nn.ReLU(),
# #             nn.Conv3d(in_channel, channel, kernel_size=3, padding=1),
# #             nn.ReLU(inplace=True),
# #             nn.Conv3d(channel, in_channel, kernel_size=1),
# #         )
...
# #         if stride == 4:
# #             blocks = [
# #                 nn.Conv3d(in_channel, channel // 2, kernel_size=4, stride=2, padding=1),
# #                 nn.ReLU(inplace=True),
# #                 nn.Conv3d(channel // 2, channel, kernel_size=4, stride=2, padding=1),
# #                 nn.ReLU(inplace=True),
...
# #                 nn.Conv3d(in_channel, channel // 2, kernel_size=4, stride=2, padding=1),
# #                 nn.ReLU(inplace=True),
# #                 nn.Conv3d(channel // 2, channel, kernel_size=3, padding=1),
# #             ]
...
# #         blocks = [nn.Conv3d(in_channel, channel, kernel_size=3, padding=1)]
...
# #             blocks.extend(
# #                 [
# #                     nn.ConvTranspose3d(channel, channel // 2, kernel_size=4, stride=2, padding=1),
# #                     nn.ReLU(inplace=True),
# #                     nn.ConvTranspose3d(
# #                         channel // 2, out_channel, kernel_size=4, stride=2, padding=1
# #                     ),
# #                 ]
# #             )
...
# #         elif stride == 2:
# #             blocks.append(
# #                 nn.ConvTranspose3d(channel, out_channel, kernel_size=4, stride=2, padding=1)
# #             )
...
# #         self.enc_b = Encoder(in_channel, channel, n_res_block, n_res_channel, stride=4)
# #         self.enc_t = Encoder(channel, channel, n_res_block, n_res_channel, stride=2)
# #         self.quantize_conv_t = nn.Conv3d(channel, embed_dim, kernel_size=1)
# #         self.quantize_t = Quantize(embed_dim, n_embed)
# #         self.dec_t = Decoder(
# #             embed_dim, embed_dim, channel, n_res_block, n_res_channel, stride=2
# #         )
# #         self.quantize_conv_b = nn.Conv3d(embed_dim + channel, embed_dim, kernel_size=1)
# #         self.quantize_b = Quantize(embed_dim, n_embed)
# #         self.upsample_t = nn.ConvTranspose3d(
# #             embed_dim, embed_dim, kernel_size=4, stride=2, padding=1
# #         )
# #         self.dec = Decoder(
# #             embed_dim + embed_dim,
# #             in_channel,
